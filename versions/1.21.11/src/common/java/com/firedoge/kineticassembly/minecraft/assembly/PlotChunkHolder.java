...
public final class PlotChunkHolder extends ChunkHolder {
    ...
    public boolean blockChanged(BlockPos pos) {
        boolean changed = super.blockChanged(pos);
        needsBroadcast = true;
        return changed;
    }

    @Override
    public boolean sectionLightChanged(LightLayer lightLayer, int sectionY) {
        boolean changed = super.sectionLightChanged(lightLayer, sectionY);
        needsBroadcast = true;
        return changed;
    }
